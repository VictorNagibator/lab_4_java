...
public class Laptop {
    ...
    @Override public String toString() {
        String result = "Название модели: " + this.name + "\n" +
                this.cpu.getComponentName() + ": " + this.cpu + "\n" +
                this.gpu.getComponentName() + ": " + this.gpu + "\n" +
                this.ram.getComponentName() + ": " + this.ram + "\n" +
                this.motherboard.getComponentName() + ": " + this.motherboard + "\n" +
                this.display.getComponentName() + ": " + this.display + "\n" +
                this.dataStorage.getComponentName() + ": " + this.dataStorage;
        return result;
    }
