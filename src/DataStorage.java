...
public abstract class DataStorage implements LaptopComponent {
    ...
    @Override public String toString()  {
        String result = String.format("%s, %d ГБ, %s, %.1f", this.getBrand(), this.getCapacity(), this.getInterface(), this.getFormFactor());
        return result;
    }
}
